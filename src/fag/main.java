...
public class main {
		...
		public static void main(String[] args) {
			...
			conta.setTitular("Isaac Saldanha");
			...
			Filme filme1 = new Filme("Telefone Preto 2", 4.9);
			Filme filme2 = new Filme();
			filme2.setTitulo("Velozes e Furiosos");
			...
			musica1.setTitulo("Um Bom Perdedor");
			musica1.setDuracaoSegundos(223);
			Musica musica2 = new Musica();
			musica2.setTitulo("Nem que seja Chorando");
			musica2.setDuracaoSegundos(191);
			...
			pessoa.setNome("Cleide dos Santos");
			pessoa.setPeso(90.5);
			...
			contaLuz.setConsumoKwh(200.0);
			contaLuz.setValorKwh(0.90);
			...
			produto.setNome("Fantasia Teletubbies");
